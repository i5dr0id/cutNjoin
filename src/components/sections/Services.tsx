  ...
  return (
    <article className="group flex flex-col gap-4 border border-fg/7 bg-card p-6 transition-colors duration-250 hover:bg-accent">
      <div className="flex items-center justify-between font-mono text-[10px] leading-[15px]">
        <span className="tracking-[1px] text-fg/16 transition-colors duration-250 group-hover:text-bg/60">
          {service.timecode && formatTimecode(service.timecode)}
        </span>
        <span className="border border-fg/14 px-2 py-0.5 tracking-[2px] text-fg/27 uppercase transition-colors duration-250 group-hover:border-bg/30 group-hover:text-bg/70">
          {service.tag}
        </span>
      </div>
      ...
      <p className="flex-1 text-sm leading-[22.75px] text-fg/41 transition-colors duration-250 group-hover:text-bg/75">
        {service.description}
      </p>
      <Link
